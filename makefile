...
SERVICES_SOURCE_FILES = delay.c
SERVICES_SOURCE_FILES += led.c
SERVICES_SOURCE_FILES += circular_buffer.c
SERVICES_SOURCE_FILES += debug.c
...
PERIPHERALS_DRIVERS_SOURCE_FILES = stm32f4xx_ll_gpio.c
PERIPHERALS_DRIVERS_SOURCE_FILES += stm32f4xx_ll_utils.c
PERIPHERALS_DRIVERS_SOURCE_FILES += stm32f4xx_ll_usart.c
PERIPHERALS_DRIVERS_SOURCE_FILES += stm32f4xx_ll_rcc.c
...
SOURCE_FILES += $(addprefix $(SYSTEM_SOURCE_DIR)/, \
	$(SYSTEM_SOURCE_FILES))
